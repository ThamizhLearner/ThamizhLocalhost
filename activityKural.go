...
func createNerTable() SimpleTable {
	...
	strs := [4]string{
		"குறில்|ப|ப (குறில்)|நேரசை(1)",
		"குறில் + ஒற்று|பல்|பல் (குறில் + ஒற்று)|நேரசை(2)",
		"நெடில்|கா|கா (நெடில்)|நேரசை(3)",
...
func createNiraiTable() SimpleTable {
	...
	strs := [4]string{
		"குறில் + குறில்|அணி (அ / ணி)|அ (குறில்) + ணி (குறில்)|நேரசை(1) + நேரசை(1)",
		"குறில் + (குறில் + ஒற்று)|அவர் (அ / வர்)|அ (குறில்) + வர் (குறில் + ஒற்று)|நேரசை(1) + நேரசை(2)",
		"குறில் + நெடில்|தொழா (தொ / ழா)|தொ (குறில்) + ழா (நெடில்)|நேரசை(1) + நேரசை(3)",
		"குறில் + (நெடில் + ஒற்று)|கினான் (கி / னான்)|கி (குறில்) + னான் (நெடில் + ஒற்று)|நேரசை(1) + நேரசை(4)",
	}
	for r := range 4 {
		row := make([]string, 4)
		t.Cells[r] = row
